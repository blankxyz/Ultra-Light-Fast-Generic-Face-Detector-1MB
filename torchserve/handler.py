...
class HiggsClassifier(BaseHandler):
    ...
    def preprocess(self, request):
        ...
        for _, data in enumerate(request):
            ...
            transform = PredictionTransform(image_size, image_mean_test, image_std)

        return transform(np.array(input_image))
    ...
    def postprocess(self, inference_output):
        ...
        return [{
            ...
            'probs': picked_box_probs[:, 4].tolist()
        }]
